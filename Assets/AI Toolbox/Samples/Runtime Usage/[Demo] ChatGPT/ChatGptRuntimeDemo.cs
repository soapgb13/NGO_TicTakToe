...
// This script demonstrates how to use the ChatGPT API in a Unity project. It creates a conversation with a character
// and allows the user to ask questions to the character. The script uses the ChatGptParameters class to store the API
